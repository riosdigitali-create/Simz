/**
 * MUNDO SIMZ — contador de público (Cloudflare Pages Function, edge)
 * ------------------------------------------------------------------
...
const SAL = 'mundo-simz-visitas-v1';
